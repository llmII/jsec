...
| SChannel          | Future  | Native Windows TLS (no OpenSSL dependency).  |
| Network.framework | Future  | Native MacOS way of doing TLS.               |
...
|--------------+---------+---------------+----------------------------------------|
| Linux        | Working | OpenSSL 3.x   | Primary development platform           |
...
| DragonflyBSD | Working | LibreSSL 3.6+ | Tested on DragonflyBSD 6.4             |
| OpenBSD      | Working | LibreSSL 3.6+ | All tests pass on OpenBSD 7.6          |
| Windows      | Working | OpenSSL 3.x   | MSVC + vcpkg, see [[file:docs/WINDOWS.org][Windows Guide]]        |
