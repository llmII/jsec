...
void jtls_module_init(JanetTable *env) {
    ...
    if (alpn_idx == -1) {
        alpn_idx = SSL_CTX_get_ex_new_index(0, NULL, NULL, NULL, jtls_alpn_free_cb);
    }
    if (sni_idx == -1) {
        sni_idx = SSL_CTX_get_ex_new_index(0, NULL, NULL, NULL, jtls_sni_free_cb);
    }
    if (ocsp_idx == -1) {
        ocsp_idx = SSL_CTX_get_ex_new_index(0, NULL, NULL, NULL, jtls_ocsp_free_cb);
    }
    ...
    JanetReg cfuns[] = {
        ...
        },
        {
            ...
            "the keyword `:all` to read until end of stream. Optionally provide\n"
        ...
        },
        {
            ...
            "available. If end of stream is reached, returns collected bytes.\n"
        },
        {
            "write", cfun_write,
        ...
        },
        {
            ...
            "Close TLS stream. Sends close_notify per RFC unless force is true.\n"
