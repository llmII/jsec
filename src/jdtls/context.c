 ...
 *
 * A DTLSContext (SSLContext) can be passed to dtls/connect or dtls/listen via the
 ...
 *   :min-version - Minimum DTLS version (:dtls1.0 or :dtls1.2)
 *   :max-version - Maximum DTLS version
