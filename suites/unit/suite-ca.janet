...
(assay/def-suite :name "CA Suite"

                 # ===========================================================================
                 # Root CA Generation
                 # ===========================================================================

                 (assay/def-test "ca/generate creates root CA with defaults"
                                 (def ca (ca/generate))
                 ...
                 (assay/def-test "ca/generate respects options"
                 ...
                 (assay/def-test "ca/generate with tracking enabled"
                 ...
                 (assay/def-test "ca/generate without tracking"
                 ...
                 (assay/def-test "ca/generate-intermediate creates signed intermediate"
                 ...
                 (assay/def-test "ca/generate-intermediate increments parent serial"
                 ...
                 (assay/def-test "ca/generate-intermediate with path-length"
                 ...
                 (assay/def-test ":issue creates cert and key"
                                 (def ca (ca/generate))
                 ...
                 (assay/def-test ":issue with extended-key-usage"
                                 (def ca (ca/generate))
                 ...
                 (assay/def-test ":issue tracks when enabled"
                                 (def ca (ca/generate {:track-issued true}))
                 ...
                 (assay/def-test ":issue increments serial"
                 ...
                 (assay/def-test "ca/create from existing cert and key"
                 ...
                 (assay/def-test "ca/create with serial restoration"
                 ...
                 (assay/def-test ":revoke adds to revocation list"
                                 (def ca (ca/generate))
                                 (:revoke ca 123)
                 ...
                 (assay/def-test "revocation reasons are valid keywords"
                                 (def ca (ca/generate))
                 ...
                 (assay/def-test ":generate-crl produces PEM CRL"
                                 (def ca (ca/generate))
                 ...
                 (assay/def-test ":generate-crl includes revoked certs"
                                 (def ca (ca/generate))
                 ...
                 (assay/def-test "ca/parse-ocsp-request exists"
                                 (assert ca/parse-ocsp-request "Function should exist"))

                 (assay/def-test ":create-ocsp-response exists as method"
                                 (def ca (ca/generate))
                 ...
                 (assay/def-test ":issue requires common-name"
                                 :expected-fail "common-name"
                                 (def ca (ca/generate))
                                 (:issue ca {}))

                 (assay/def-test "ca/generate handles invalid key-type"
                 ...
                 (assay/def-test "full PKI workflow"
                                 :timeout 15
                                 # Create root CA
