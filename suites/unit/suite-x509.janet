...
(assay/def-suite :name "X.509 Verification"
                 ...
                 (assay/def-test "parse - extracts version"
                 ...
                 (assay/def-test "parse - extracts validity period"
                                 (def certs (cert/generate-self-signed-cert {:common-name "test"
                                                                             :days-valid 30}))
                                 (def parsed (cert/parse (certs :cert)))
                                 (def now (os/time))
                 ...
                 (assay/def-test "parse - extracts RSA key info"
                                 (def certs (cert/generate-self-signed-cert {:common-name "test"
                                                                             :key-type :rsa
                                                                             :bits 2048}))
                                 (def parsed (cert/parse (certs :cert)))
                 ...
                 (assay/def-test "parse - extracts EC key info"
                                 (def certs (cert/generate-self-signed-cert {:common-name "test"
                                                                             :key-type :ec-p256}))
                                 (def parsed (cert/parse (certs :cert)))
                                 (def pk (parsed :public-key))
                 ...
                 (assay/def-test "parse - extracts SAN"
                                 (def certs (cert/generate-self-signed-cert {:common-name "test"
                                                                             :san ["example.com"
                                                                                   "*.example.com"
                                                                                   "192.168.1.1"]}))
                 ...
                 (assay/def-test "parse - extracts fingerprints"
                                 (def certs (cert/generate-self-signed-cert {:common-name "test"}))
                                 (def parsed (cert/parse (certs :cert)))
                 ...
                 (assay/def-test "verify-chain - with intermediate"
                                 # Generate root CA
                 ...
                 (assay/def-test "verify-chain - hostname match CN"
                 ...
                 (assay/def-test "verify-chain - hostname in default SAN"
                                 (def certs (cert/generate-self-signed-cert {:common-name "test.example.com"
                                                                             :is-ca true}))
                                 (def parsed (cert/parse (certs :cert)))
                 ...
                 (assay/def-test "verify-chain - hostname mismatch"
                 ...
                 (assay/def-test "verify-chain - expired cert"
                 ...
                 (assay/def-test "verify-chain - not yet valid"
                 ...
                 (assay/def-test "verify-chain - untrusted self-signed"
                 ...
                 (assay/def-test "verify-chain - missing intermediate"
                 ...
                 (assay/def-test "parse - preserves PEM"
                                 (def certs (cert/generate-self-signed-cert {:common-name "test"}))
                                 (def parsed (cert/parse (certs :cert)))
                                 (assert (= (certs :cert) (parsed :pem)) "Should preserve original PEM"))

                 (assay/def-test "parse - handles multiple certs in PEM"
