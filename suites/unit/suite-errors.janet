...
(assay/def-suite :name "errors"
                 ...
                 (assay/def-test "state error - BIO write after close"
                                 :expected-fail "BIO should error on write after close"
                                 (def b (bio/new-mem))
                                 (:close b)
                                 (:write b "data"))

                 (assay/def-test "state error - BIO read after close"
                 ...
                 (assay/def-test "config error - TLS invalid cert file"
                 ...
                 (assay/def-test "config error - TLS invalid protocol version"
                 ...
                 (assay/def-test "dtls error - listen without cert/key"
                                 :expected-fail "DTLS listen should require cert/key"
                                 (dtls/listen "127.0.0.1" "0" {}))

                 (assay/def-test "dtls error - connect to non-listening"
